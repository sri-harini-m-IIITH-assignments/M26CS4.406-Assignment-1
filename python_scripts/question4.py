...
def run_q4():
    run_q4_dataset(
        ...
        train_path="split_data/mind_train.parquet",
        val_path="split_data/mind_val.parquet",
        bm25_index_path="bm25_indexes/mind_bm25.pkl",
        faiss_index_path="faiss_indexes/mind_faiss.pkl",
        language="english",
    )
    run_q4_dataset(
        dataset_name="EB-NeRD Validation",
        train_path="split_data/ebnerd_train.parquet",
        val_path="split_data/ebnerd_val.parquet",
        bm25_index_path="bm25_indexes/ebnerd_bm25.pkl",
        faiss_index_path="faiss_indexes/ebnerd_faiss.pkl",
        language="danish",
    )
