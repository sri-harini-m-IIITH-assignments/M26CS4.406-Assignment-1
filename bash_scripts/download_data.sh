...
# download "https://mind201910small.blob.core.windows.net/release/MINDlarge_train.zip" "./zip/MINDlarge_train.zip"
# download "https://mind201910small.blob.core.windows.net/release/MINDlarge_dev.zip" "./zip/MINDlarge_dev.zip"
# download "https://mind201910small.blob.core.windows.net/release/MINDlarge_test.zip" "./zip/MINDlarge_test.zip"
# download "https://ebnerd-dataset.s3.eu-west-1.amazonaws.com/ebnerd_large.zip" "./zip/ebnerd_large.zip"
...
# extract "./zip/MINDlarge_dev.zip" "./data/MINDlarge_dev"    
# extract "./zip/MINDlarge_test.zip" "./data/MINDlarge_test"
# extract "./zip/ebnerd_large.zip" "./data_large/ebnerd_large"
